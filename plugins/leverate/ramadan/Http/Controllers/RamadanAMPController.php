...
class RamadanAMPController extends Controller
{
    ...
    {   
        ...
        if ($validator->fails()) {
            ...
            {	
                ...
                //get the code         
                $get_code = SkmMart::where('status',null)->get()->first();
            ...
            return redirect()->to(url('/amp/aktivitas-kami/ramadan-istimewa/thank-you'))->with('data', $data)->withCookie(cookie()->forever($promo,$code));
