						...
						return function() {
							var that = this,
								...
								mightThrow = function() {
									...
									// Support: Promises/A+ sections 2.3.4.0, 3.5
							...
							// Support: Promises/A+ section 2.3.3.4.0
...
if ($(window).width() < 992) {
   ...
   $(document).ready(function() {
    ...
    $(window).on('scroll', function() {
      ...
      // Get window top
      var windowTop = $(this).scrollTop() + 70;

      // Get menu link target
      var $targets = $('#menu').find('a');
      
      // Get target offset top
      $targets.each(function(i, row) {
        
        // Get Target
        var $target = $($(row).attr('href'));

        // Check top offset of target, if between the topcurrent and heightcurrent
        var topCurrent = $target.offset().top;
        var heightCurrent = $target.outerHeight();
        
        if (windowTop > topCurrent && windowTop < (topCurrent + heightCurrent))
        {
          $(row).parent().addClass('active');
          $(row).parent().siblings().removeClass('active');

          var hash = $(row).attr('href');
...
//console.log(myWindowURL);
function openFacebookDialog(){
var myWindowURL = encodeURIComponent(location.href);
var myWindowTitle = "Frisian Flag Ramadhan";
var myWindowDescription = "Awali puasa dengan nutrisi saat sahur, akhiri dengan manis untuk sambut lebaran";
var myWindowPicture = "https://www.frisianflag.com/themes/rainlab-bonjour/assets/img-ramadhan/share.jpg";
  window.open(
